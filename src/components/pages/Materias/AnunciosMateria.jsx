...
import { getAnunciosMateria, borrarComentario, crearComentario } from "../../../actions/anuncios";
            ...
            <div className="profile-env">
              ...
              <section className="profile-feed">
                { !auth.loading && auth?.user?.perfiles[0].tipo[0].administrador === true &&
                    ...
                    onSubmit={(e) => {
                      e.preventDefault();
                      crearAnuncioMateria({ contenido,tipo,imagenURL },match.params.id);
                            ...
                            <ul className="comments">
                                          ...
                                          comentario?.autor?._id ===
                                            ...
                                            <div>
                                              <button className="btn btn-danger text-white" onClick={(e) => {
                                                  ...
                                                  borrarComentario(item?._id, comentario._id)
                                                  setResetAnuncios(!resetAnuncios)
                              ...
                              <li className="comment-form">
                                ...
                                <div className="user-comment-content">
                                  ...
                                  onSubmit={(e) => {
                                    e.preventDefault();
                                    crearComentario({ descripcion }, item._id);
                                    setResetAnuncios(!resetAnuncios)
                                    setDescripcion("");
                                  }}
                                  >
