...
const Login = ({login, isAuthenticated}) => {
    ...
    return (
      ...
      <div className="containerLogin">
            ...
            <p className="message"><strong>Cuentas Para Usar</strong></p>
            <p className="message"><strong>Alumno:</strong> DNI-44343138 , Pass-123456 </p>
            <p className="message"><strong>Admin:</strong> DNI-44111222 , Pass-123456 </p>
            </div>
      </div>
      </>
  ) 
